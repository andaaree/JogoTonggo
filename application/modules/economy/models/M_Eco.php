...
class M_Eco extends CI_Model
{

    public function getTotKab()
    {
        $uri = substr($this->uri->uri_string(), 0, 8);
    ...
    public function getOptRes()
    {
        ...
        $qry = $this->db->query("SELECT DISTINCT cat_name,rw_res.quest_id,quest_type,quest_full FROM rw_res,v_form_eco WHERE rw_res.quest_id=v_form_eco.quest_id ORDER BY quest_type DESC;");
