                    ...
                    <div class="card">
                        <div class="card-header mt-3">
                            <h3 class="card-title">
                                ...
                                Daftar Pertanyaan SosKam
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="<?= base_url('') ?>forms/saveSoc">
                                <?php
                                $no = 1;
                                foreach ($ans as $o) { ?>
                                    ...
                                    <?php if ($o['quest_type'] == 'opt') { ?>
                                        <div class="form-group">
                                            <?php
                                            if (strpos($o['quest_full'], 'Sembako') != false) { ?>
                                            ...
                                            <?php }
                                            elseif (strpos($o['quest_full'], 'umber') != false) { ?>
                                                <div class="icheck-red d-inline">
                                                    <input value="Swadaya" type="radio" name="ans<?= $no; ?>" id="ans<?= $no; ?>a">
                                                    <label for="ans<?= $no; ?>a">Swadaya</label>
                                                </div>
                                                <div class="icheck-red d-inline ml-3">
                                                    <input value="Pemerintah" type="radio" name="ans<?= $no; ?>" id="ans<?= $no ?>b">
                                                    <label for="ans<?= $no; ?>b">Pemerintah</label>
                                                </div>
                                            <?php } else { ?>
                                                <div class="icheck-red d-inline">
                                    ...
                                    <?php } elseif ($o['quest_type'] == 'essay') { ?>
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="ans<?= $no; ?>" placeholder="<?php if (strpos($o['quest_full'], 'Swadaya') != false) {
                                                                                                                            echo "Contoh : CSR Instansi / Iuran Warga";
                                                                                                                        } elseif (strpos($o['quest_full'], 'Pemerintah') != false) {
                                                                                                                            echo "Contoh : Bansos ( Tunai / Pangan ) Atau ( Kota / Kabupaten )";
                                                                                                                        } elseif (strpos($o['quest_full'], 'Pemudik') != false) {
                                                                                                                            echo "Pilih : Jateng / Luar Jateng";
                                                                                                                        } ?>">
                                        </div>
                                <?php }
                                    $no++;
